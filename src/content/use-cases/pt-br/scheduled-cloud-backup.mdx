...
description: "Faça backup de pastas importantes da nuvem para S3 ou outro destino em uma programação, com detecção de alterações e um relatório no final de cada run."
eyebrow: "Para usuários e times pequenos que querem backups recorrentes"
headline: "Faça backup de pastas da nuvem em uma programação."
...
3. Escolha uma programação — diária, semanal ou contínua.
...
Defina uma programação uma vez e o job vai rodar sozinho — snapshots diários, cópias semanais de workspace, um mirror contínuo de um projeto crítico. A programação mantém o backup em dia; você deixa de ser o cron job.
...
Backups são sobre volume, frequência e retenção — não sobre assentos. Veja preços para a escala dos planos.
