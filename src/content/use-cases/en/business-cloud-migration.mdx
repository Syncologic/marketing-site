...
description: "Move team files to a new cloud workspace with a preview, progress tracking, and a final report — without dragging gigabytes through a computer."
...
1. Connect the source workspace — Google Drive, OneDrive, Dropbox, S3, SFTP, your server, or Nextcloud.
